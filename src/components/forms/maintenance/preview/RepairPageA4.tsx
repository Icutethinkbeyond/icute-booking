...
interface FormContentProps {
  goodsEmptyRows: number;
  activityEmptyRows: number;
  materialEmptyRows: number;
  setGoodsEmptyRows: (value: number) => void;
  setActivityEmptyRows: (value: number) => void;
  setMaterialEmptyRows: (value: number) => void;
}
...
export default function RepairPaperForm() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const pageHeight = 297 * 3.7795275591 - 100;
        ...
        newPages.push(
          <A4Paper key={i} elevation={0} id={`repair-paper-page-${i}`}>
            ...
            >
              ...
              >
                <FormContent
                  goodsEmptyRows={goodsEmptyRows}
                  activityEmptyRows={activityEmptyRows}
                  materialEmptyRows={materialEmptyRows}
                  setGoodsEmptyRows={setGoodsEmptyRows}
                  setActivityEmptyRows={setActivityEmptyRows}
                  setMaterialEmptyRows={setMaterialEmptyRows}
                />
              </Box>
            </Box>
          </A4Paper>
      ...
      setPages(newPages);
      setTimeout(() => setHideContent(true), 100);
    }, 0); // หน่วง 1 cycle ให้ React อัปเดต DOM
  }, [goodsEmptyRows, activityEmptyRows, materialEmptyRows]);
  ...
  //   console.log(pageHeight, pageCount, contentHeight);
  ...
  // Component for row management buttons
  const RowManagementButtons = ({
    ...
    const sectionNames = {
      ...
      activity: "Activity of repairing",
    ...
    <>
      ...
      >
        ...
        >
          ...
          <RowManagementButtons section="activity" />
          <RowManagementButtons section="material" />
        </Box>
        <Button
          startIcon={<Download />}
          variant="contained"
